...
import { parsePackagingString, normalizePackagingString } from '../../utils/parser';
...
export const InventoryTab: React.FC = () => {
  ...
  const stockLevels = useMemo(() => {
    return buildStockLevels({ products, outputEntries, dispatchEntries, stockAdjustments });
  }, [products, outputEntries, dispatchEntries, stockAdjustments]);
